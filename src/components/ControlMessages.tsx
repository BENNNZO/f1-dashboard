...
export default function ControlMessages() {
    ...
    console.log(Object.entries(raceControlMessages.Messages))

    return (
        <div className="flex flex-col gap-2 p-2">
            {Object.entries(raceControlMessages.Messages).map((message: any) => {
                const { Message, Category } = message[1]

                return (
                    <div className="bg-zinc-900 rounded-xl flex flex-col gap-2 p-2">
